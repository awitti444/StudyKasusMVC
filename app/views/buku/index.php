<div class="container">
    ...
    <br>
        ...
        <form action="<?= BASE_URL;?>/buku/cari" method="post" class= "d-flex" style="margin-right: 0.5rem;">
            <input type="text" name="cari" id="" class="form-control" style="border: solid 1px grey; margin-right: -0.1rem" placeholder="Cari...">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                        ...
                        //strtotime untuk melakukan konversi tanggal dan waktu.

                        // Menghitung selisih hari antara tanggal kembali dan tanggal pinjam
                         //floor digunakan untuk membulatkan hasil perhitungan
                  ...
                  <td> 
                    <?php
                        ...
                        if ($selisih_hari == 0 || $selisih_hari == 1 || $selisih_hari > 2) {
                            ...
                            echo '<a href="' . BASE_URL . '/buku/edit/' . $row['id'] . '" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i>Edit</a>';
